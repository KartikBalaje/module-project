...
<header style="background: #38C6A3">
  ...
  <nav>
      ...
      <li><a href="ms.php" >Assing worker</a></li>
              ...
              <li><a href="assign_worker_sissues.php" class="active">Supervisor issues</a></li>
...
async function assignWorker(issue, selectedWorker) {
    try {
        ...
        const response = await fetch('/equ health/endpointsuper.php?action=assignWorker', {
            method: 'POST',
            headers: {
...
async function fetchWorkers() {
    try {
        const response = await fetch('/equ health/endpointsuper.php?action=getWorkers');
        const data = await response.json();
...
async function fetchIssues() {
    try {
        const response = await fetch('/equ health/endpointsuper.php?action=getIssues');
        const data = await response.json();
