...
<nav>
    ...
    <!-- <li><a href="ms.php">Home</a></li> -->
            <li><a href="whistory.php" >View issues</a></li>
            <li><a href="wsuperhistory.php" class="active">Supervisor issues</a></li>
...
<script>
   function updateStatus(issueId) {
    ...
    function showRemarks(issueId) {
        fetch('superget_remarks.php', { // Replace with the actual endpoint to fetch remarks
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
